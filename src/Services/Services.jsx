...
<div className="services__intro">
    ...
    <div>
      <div className="services__intro__text">
        ...
        <p className="text">
        All our services are delivered by a team of experienced developers, 
        designers, and consultants who are passionate about technology and 
        committed to delivering the best possible solutions to our clients. 
        We use the latest technologies and industry best practices to deliver software that is robust, 
        scalable, and easy to use. Contact us today to discuss your project and see how we can help you achieve your goals.
        </p>
